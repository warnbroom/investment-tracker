...
- **Data sources:** banggia.doji.vn (vàng DOJI, API chính chủ — payload AES-256-CBC, giải bằng Web Crypto; fallback giavang.org), www.vietcombank.com.vn/api/exchangerates (tỷ giá VCB, JSON chính chủ), api.fmarket.vn (NAV quỹ)
